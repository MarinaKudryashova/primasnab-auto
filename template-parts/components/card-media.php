...
<div class="card-media">
  <div class="card-media__video video" id="video-<?php echo esc_attr($page_id . '-' . $slide_index); ?>" data-video-url="<?php echo esc_url($media_video_url); ?>" <?php if ($media_type === 'video') : ?> data-is-file="true" <?php endif; ?>>
