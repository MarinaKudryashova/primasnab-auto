...
$left_image_url = get_field($sec_name . '_image', $page_id)['url'] ?? '';
$right_image_url = get_field($sec_name . '_right-image', $page_id)['url'] ?? '';
